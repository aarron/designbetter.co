...
var init = function() {
  canvas = document.getElementById("black-box-animation");
  if (canvas) {
    handleComplete();
  }
}
function handleComplete() {
  ...
  var container = $('#black-box-animation-container');
  exportRoot = new blackBoxLib.Factory();
  stage = new createjs.Stage(canvas);
  stage.addChild(exportRoot);
  //Registers the "tick" event listener.
  createjs.Ticker.setFPS(blackBoxLib.properties.fps);
  ...
  (function(isResp, respDim, isScale, scaleType) {
    ...
    function resizeCanvas() {
      var w = blackBoxLib.properties.width, h = blackBoxLib.properties.height;
